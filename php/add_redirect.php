...
if (isset($postdata)) {
    ...
    if ($choice_code == $parent) {
        echo json_encode(DisplayMessage("2", "Cannot add a redirect to current choice, infinity loop?"));        
        
    } 
    else if ($choice_code == "" || $parent == "" || $choice_text == "") {
        echo json_encode(DisplayMessage("2", "Blank fields...!"));
    } 
    else {
        ...
        echo json_encode(DisplayMessage("1", "Redirect Successful"));
